...
//    // GET: api/Appointment/date/2023-05-15
//    [HttpGet("date/{date}")]
...
//        {
//            return BadRequest("There is already an appointment scheduled at this time");
//        }
...
//        // Validate status
//        if (!new[] { "Scheduled", "Completed", "Cancelled", "No-Show" }.Contains(status))
//        {
